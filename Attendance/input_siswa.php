...
if (isset($_POST["submit"])) {
    ...
    $nama_like = '%' . $nama . '%';
    $stmt->bind_param("ssss", $nama_like, $kelas, $jurusan, $nisn);
    $stmt->execute();
...
<head>
    ...
    <link rel="stylesheet" href="assets\css\input_siswa.css">
</head>
    ...
    <div id=" addModal" class="modal-add">
        <div class="modal-content">
            <form method="POSt">
                ...
                <button type="button" id="kembali" name="kembali" class="btn-back"><a href="list.php">Kembali ke List</a></button>
